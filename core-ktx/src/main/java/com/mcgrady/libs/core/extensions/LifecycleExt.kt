...
class LifecycleCallbacks(private var destroyed: (() -> Unit)? = null) : ActivityLifecycleCallbacks {
...
class LifecycleFragment constructor(private var destroyed: (() -> Unit)? = null) :
